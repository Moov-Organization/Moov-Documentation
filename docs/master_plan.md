...
2. __Decentralized Ride Hailing__, No central entity like Uber owns the ride hailing network it is rather hosted on a decentralized network of computers communicating through [open protocols](https://github.com/Moov-Organization/demo2/truffle/contracts/MoovRideManager.sol). This means our customers do not have to pay a commission to any middlemen.
